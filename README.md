...
Demo Project uses a large document as a text sample. The first page of the output report is: 

<img src="https://github.com/jrzelling/wordcloudReports/blob/main/docs/page1.PNG" alt="na" width=80% height=80%/>

The report generates the following files for each chapter of the document: 
